...
import { contractEnum, web3Enum, tokenEnum, userEnum } from "src/context/enum";
...
export const ContractsProvider = ({ children }) => {
  ...
  const [contracts, dispatchContracts] = useReducer(contractReducer, {
    ...
    transactions: [],
    transactionCount: typeof window !== 'undefined' ? + window.localStorage.getItem("transactionCount") : null,
    tokenPrice: 0,
